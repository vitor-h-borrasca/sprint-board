      ...
      <div style={{
        ...
        <div style={{
          ...
          {tab === 'pbi' && <>
            ...
            {status === 'offline' && (
              <span style={{ fontSize: 11, color: 'var(--red-tx)', alignSelf: 'center' }}>
                ● servidor offline —{' '}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ fontSize: 11, color: 'var(--teal)', textDecoration: 'none', alignSelf: 'center', marginLeft: 12 }}
            >
              ↗ abrir em nova aba
            </a>
          </>}
          ...
          status === 'offline' ? (
            <div style={{
              ...
              <p style={{ fontSize: 14, color: 'var(--text2)', textAlign: 'center', maxWidth: 360, lineHeight: 1.6 }}>
                ...
                Abra um terminal na pasta <strong style={{ color: 'var(--text)' }}>Criador de PBIs</strong> e execute:
              </p>
              <code style={{
                background: 'var(--surface2)', border: '1px solid var(--border)',
                borderRadius: 8, padding: '10px 20px', fontSize: 13, color: 'var(--teal)',
              }}>
                npm run start
              </code>
              <button onClick={() => { setStatus('checking'); setTimeout(() => location.reload(), 300) }}>
                Tentar novamente
              </button>
            </div>
          ) : (
